...
0. https://github.com/grig22/python2021/blob/006f4d9be360a9e658b9cf07a09bd997982982c3/3-scoring-api/my_app/store.py#L28 - вместо такого наверное, лучше сначала попробовать соединиться, если получится, то и спать не понадобится
1. https://github.com/grig22/python2021/blob/006f4d9be360a9e658b9cf07a09bd997982982c3/3-scoring-api/my_app/store.py#L45 - давайте использовать logging для логирования там, где это необходимо
2. как и указано в описании ДЗ: нужны модульные тесты полей и интеграционные тесты store с реальным хранилищем
3. п.1 изпрошлого ревью не реализован
"""
