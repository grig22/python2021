...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../my_app')))  # >_<
...
class TestSuite(unittest.TestCase):
    ...
    def test_empty_request(self):
        ...
        self.assertEqual(hs.UNPROCESSABLE_ENTITY, code)
    ...
    def test_bad_auth(self, request):
        ...
        self.assertEqual(hs.FORBIDDEN, code)
    ...
    def test_invalid_score_request(self, arguments):
        ...
        self.set_valid_auth(request)
        response, code = self.get_response(request)
        self.assertEqual(hs.UNPROCESSABLE_ENTITY, code, arguments)
        self.assertTrue(len(response))
